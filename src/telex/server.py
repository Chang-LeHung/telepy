...
class TeleXHandler(BaseHTTPRequestHandler):
    """
    All the following fileds are auto-generated by telex.
    """
    ...
    def __init__(self, request, client_address, server) -> None:
        ...
        self.telex_headers: dict[str, str] = {}
        self.req: TeleXRequest
        self.resp: TeleXInterceptor
        self.interceptor: TeleXInterceptor
        self.log: bool
    ...
    def send_response(self, code, message=None):
        ...
        self.send_header("Server", f"TeleX Monitoring Server/{__version__}")
        self.send_header("Date", self.date_time_string())


class TeleXException(Exception):
...
class TeleXResponseMixin:
    """
    Add lifecycle methods to TeleXResponse.
    """
...
class TeleXResponse(TeleXResponseMixin):
...
class TeleXInterceptor(TeleXResponse):
...
class TeleXApp:
    ...
    def route(
        ...
        if method not in self.supported_methods:
            raise TeleXException(f"Method {method} is not supported")
